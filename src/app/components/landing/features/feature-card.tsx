...
export function FeatureCard({ description, title, children }: Props) {
  return (
    <section className="flex flex-col gap-1 overflow-hidden rounded-md border border-muted bg-primary/5 shadow-xl transition hover:border-primary/30">
      <div className="relative flex h-full max-h-[146px] items-center justify-center overflow-hidden bg-background px-2">
